...
<div class="container">
    ...
    <table> <!--Inicio de la tabla-->
        <p align="center">
            <tbody>
            <tr><th> Alumnos </th><th>Visualizar reporte</th><th>Editar reporte </th></tr>
            <tr class="suave"><td class="shir"> Nombre Apellido_1 Apellido_2 </td> <td><input type="button" value="Ver"></td> <td><input type="button" value="Reporte"></td></tr>
            <tr class="suave"><td class="shir"> Nombre Apellido_1 Apellido_2 </td> <td><input type="button" value="Ver"></td> <td><input type="button" value="Reporte"></td></tr>
            <tr class="suave"><td class="shir"> Nombre Apellido_1 Apellido_2 </td> <td><input type="button" value="Ver"></td> <td><input type="button" value="Reporte"></td></tr>
            <tr class="suave"><td class="shir"> Nombre Apellido_1 Apellido_2 </td> <td><input type="button" value="Ver"></td> <td><input type="button" value="Reporte"></td></tr>
            </tbody>
